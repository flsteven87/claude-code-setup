...
12 skills live as real files under `skills/` — clone the repo and they work immediately, no plugin install required.
...
| `humanizer` (vendored, [blader/humanizer](https://github.com/blader/humanizer) v2.9.1 — update by re-cloning, do not hand-edit) | Strip signs of AI-generated writing from text |
