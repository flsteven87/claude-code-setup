...
// Model routing per ~/.claude/CLAUDE.md Multi-Agent Model Economics:
// haiku search/fetch · sonnet scope/verify · ONLY synthesis inherits the session model.
...
// Synthesis intentionally unpinned — the ONE seat that inherits the session model.
